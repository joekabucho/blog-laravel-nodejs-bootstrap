    ...
    <div class="container-fluid">
        <nav class="navbar navbar-dark navbar-expand-lg">
            ...
            <div class="navbar-collapse collapse" id="blog-navbar-collapse">
                <ul class="navbar-nav">
                    <li class="nav-item"><a class="nav-link" href="{{ route('achieve') }}">archive</a></li>
                ...
                <ul class="nav navbar-nav ml-auto justify-content-end">
                    ...
                    @if(Auth::check())
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                <a class="dropdown-item" href="{{ route('user.show', $user->name) }}">Personal center</a>
                                @if(isAdmin(Auth::user()))
                                    <a class="dropdown-item" href="{{ route('admin.index') }}">Backstage management</a>
                                @endif
                    ...
                    @else
                        ...
                        <li class="nav-item"><a class="nav-link" href="{{ url('register') }}">registered</a></li>
                    @endif
